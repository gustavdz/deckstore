...
@section('title','Bienvenido a DeckStore')
@section('styles')
    <style>
        .team .row .col-md-4{
            margin-bottom: 5em;
...
@section('content')
    <div class="header header-filter" style="background-image: url('https://images.unsplash.com/photo-1423655156442-ccc11daa4e99?crop=entropy&dpr=2&fit=crop&fm=jpg&h=750&ixjsv=2.1.0&ixlib=rb-0.3.5&q=50&w=1450');">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="title">Bienvenido a Deckstore</h1>
                    <h4>Realiza pedidos en línea y te contactaremos para cordinar la entrega.</h4>
                    <br />
            ...
            <div class="section text-center section-landing">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h2 class="title">¿Por qué DeckStore?</h2>
                        <h5 class="description">Puedes revisar la relación de nuestros productos, comparar precios y realizar tus pedidos cuando estes seguro.</h5>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="info">
                                ...
                                <p>Todo pedido que realices será confirmado a través de una llamada. Si no confías en los pagos en línea, puedes pagar contraentrega el valor acordado.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info">
